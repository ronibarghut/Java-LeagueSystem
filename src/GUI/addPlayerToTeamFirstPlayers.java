...
public class addPlayerToTeamFirstPlayers  extends MyInternalFrame {
	...
	public addPlayerToTeamFirstPlayers(){
		super("Add Player To Team First Players");
	...
	public void actionPerformed(ActionEvent arg0) {
		try {
			...
			int TeamNum = teamComboBox.getItemAt(teamComboBox.getSelectedIndex());
				if(sysData.addPlayerToTeamFirstPlayers(PlayerID, TeamNum)) {
					messageBox.showInternalInformationMessage("Player " + PlayerID +
							"\nhas successfully been added to team First Players");
				}
				else {
					messageBox.showInternalErrorMessage("Failed to add Player " + PlayerID +
							"\nto team First Players");
				}
		}
		}
		catch(Exception e) {
