...
public class removeCoach  extends MyInternalFrame {
	...
	public removeCoach() {
	    ...
	    final JLabel StadLabel = new JLabel("Coach ID:");
		...
		CoachComboBox.setBounds(265, 71, 241, 20);
	...
	public void actionPerformed(ActionEvent arg0) {
		try {
			...
			else if(arg0.getActionCommand().equals("Remove Coach")){
			...
			int CoachID = CoachComboBox.getItemAt(CoachComboBox.getSelectedIndex());
				if(sysData.removeCoach(CoachID)) {
					messageBox.showInternalInformationMessage("Coach " + CoachID +
							"\nhas successfully been removed " );
				}
				else {
					messageBox.showInternalErrorMessage("Failed to Remove Coach " + CoachID  );
				}
